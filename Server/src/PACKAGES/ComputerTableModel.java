...
public class ComputerTableModel extends AbstractTableModel {
    ...
    String columnNames[] = {"STT", "Tên máy", "IP máy", "Cổng kết nối", "Thời gian kết nối"};
    ...
    private ComputerModel createComputerModel(Socket s) {
        ...
        com.setDate(java.util.Calendar.getInstance().getTime());
        return com;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        try {
            switch (columnIndex) {
                ...
                case 4:
                    return listComputer.get(rowIndex).getDate();
